...
# ╔═╡ 12f90d70-9b65-11f1-9aa2-d5efd0937818
using LinearAlgebra, BenchmarkTools, Plots

# ╔═╡ 46b2f1ed-5f1e-44bd-893b-69181546444f
let 
	A = [3 5 1; 1 -6 1; 1 0 1]
	b = [8, 4, 2]

	x = A \ b #la documentacion de \(a,b) dice el algoritmo que usa.
	@info x
end

# ╔═╡ c0499fb9-fcf9-4392-85cb-13420f6b5c44
md"### Comparar algoritmos de `A \ b` vs. `inv(A) * b`"

# ╔═╡ 19613076-5968-4bf9-b926-82fb916f96d6
begin
	A = rand(10,10)
	b = rand(10)
	@info "A:" A
...
# ╔═╡ 9171da29-9329-4565-9cf5-92be47135144
@benchmark A \ b

# ╔═╡ 2e75d2d1-cb46-4a36-9617-5602c956cfe9
@benchmark inv(A) * b

# ╔═╡ 27d8046b-e21d-4c1a-ac02-f3e8ca3be2f2
md"### Ejercicio 11"

# ╔═╡ 447f75e2-9edb-46c1-8963-9805f555bf7f
md"#### a)"

# ╔═╡ 0fc844d9-9167-4fb7-b881-d36eb1f28304
let
...
# ╔═╡ cc5eaf1c-30e5-4a91-99d6-4c12ae358c0e
md"#### b)"

# ╔═╡ 55357cf4-c7d0-42e0-a9a1-786200c915e6
let
	N = 10
	A = zeros(N,N)
...
# ╔═╡ 531d3aa7-68e0-45a4-b3be-b4da74a01864
let
	N = 100
	A = zeros(N,N)
...
manifest_format = "2.0"
project_hash = "e2906d207fd4879975d9108855c8936332965e71"
