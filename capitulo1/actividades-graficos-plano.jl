...
# ╔═╡ 961ca3d0-9b59-11f1-a81d-7189e0453ca5
using Plots

# ╔═╡ f005fc38-92d1-4baf-89d3-3de56c842179
md" - La función seno en el intervalo [0,2π]"

# ╔═╡ 0da8441e-f8e5-457c-921a-0a3e762e3298
let
	x = 0:0.01:2pi
	y = sin.(x)
...
# ╔═╡ 8044589b-6331-4c62-b264-5fd49022de69
md"- La función ``f(x) = x^2`` en el intervalo [-1,1]"

# ╔═╡ d1751038-e299-40b1-918d-c5bdb12105b1
let
	x = -1:0.01:1
	y = x.^2
...
# ╔═╡ af872f68-6c0f-4169-9e51-101502b0dc95
md"""
- La curva dada por 
```math
\left\{\begin{aligned}
...
# ╔═╡ 7751b175-12b9-4aae-ac6b-563dabe6b359
let
	t = 0:0.01:2pi
	x = cos.(t)
	y = sin.(t)
...
# ╔═╡ 5a7959fe-151c-4aa7-97ad-9e1e6feecbde
md"""
- La curva dada por 
```math
\left\{\begin{aligned}
	x &= t\cos t\\
	y &= t\sin t
\end{aligned}\right.,\quad t\in[0,6\pi]
```
"""

# ╔═╡ 956773f6-3d13-480b-b6d4-fcf30d97a3bc
let
	t = 0:0.01:6pi
	x = @. t * cos(t)
	y = @. t * sin(t)
...
# ╔═╡ 1ca60580-e177-46a5-880c-59bd05a298b8
md"""
- La curva dada por 
```math
\left\{\begin{aligned}
	x &= e^t\cos t\\
	y &= e^t\sin t
\end{aligned}\right.,\quad t\in[0,4\pi]
```
"""

# ╔═╡ 61562058-9c5a-455e-8ede-bfb91c0fb77f
let
	t = 0:0.01:4pi
	x = @. exp(t) * cos(t)
	y = @. exp(t) * sin(t)
...
# ╔═╡ 315f45a4-14d5-4edf-b147-e34a27cf8971
md"""
- La curva dada por 
```math
\left\{\begin{aligned}
...
# ╔═╡ f1df3284-1e44-4b36-a2d9-ee9fae248e2a
let
	t = 0:0.01:6pi
	x = cos.(t)
	y = sin.(t)
...
# ╔═╡ ffa807d0-6e92-4a1a-9685-b9a38deb24c8
let
	x = 0:.1:3
...
# ╔═╡ d7db1b5d-2a20-47fb-87b9-d8a59e6feb93
let
	x = 0:.1:3
	...
	annotate!(grafico, 2, 3, "y1 = x + 1")
end

# ╔═╡ ac727c96-790c-4df7-892b-4f1ca9561f3e
md"### Ejercicio 8"

# ╔═╡ 09fb6a61-27bb-45fe-bb07-e82e037ce2a8
let
	f(x) = sin(pi * x)
	g(x) = sin(2 * pi * x)
...
# ╔═╡ 10d6ab7b-42d6-47d6-b726-f6a7fc8db408
let
	f(x) = cos(pi * x)
	g(x) = sin(3 * pi * x)
...
# ╔═╡ 65150db6-910d-433d-afe6-6703232c2014
let
	f(x) = sin(4 * pi * x)^2
	g(x) = cos(8 * pi * x)
...
# ╔═╡ 30de5ff4-6fcb-4a61-b7b1-39e72c55e74b
md"... etc"

# ╔═╡ d8a1a0d4-fa98-4aeb-bbf5-c366b6ad3fc1
let
	x = range(-pi, pi, 100)
	f = sin.(x)

	g1 = x
	g2 = @. g1 - x^3 / factorial(3)
	g3 = @. g2 + x^5 / factorial(5)
	g3 = @. g3 - x^7 / factorial(7)
